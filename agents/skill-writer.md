...
6. **Review with human** (Matt-style): coverage, missing edge cases, depth; **user-facing** messages per **`.cursor/rules/language.mdc`** (pt-BR for what you say to the user; skill body typically English unless they ask otherwise).
