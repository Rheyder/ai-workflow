...
| `language` | rule `.mdc` | **pt-BR** no **chat Cursor** com o utilizador; **inglês** (`en_US`) para todo o conteúdo no repositório e **mensagens de commit** Git. **Arquivo:** `.cursor/rules/language.mdc`. |
...
| `language.mdc`                       | contexto persistente / sempre-on  | `alwaysApply: true` | Convenção de idioma (chat pt-BR; repositório e commits `en_US`)                                              | `.cursor/rules/language.mdc` |
