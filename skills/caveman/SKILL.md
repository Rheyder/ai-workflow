---
name: caveman
description: Ultra-short replies when user requests caveman mode or fewer tokens. Toolbox only. Does not waive evidence or required reports.
---
...
- User says caveman mode, fewer tokens, or be brief (extreme).
