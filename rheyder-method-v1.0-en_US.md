...
| `language` | rule `.mdc` | **English** (`en_US`) for the entire repository, Git **commit messages**, and assistant chat; **exception:** **`rheyder-method-v1.0-pt_BR.md`** remains **Brazilian Portuguese**. **File:** `.cursor/rules/language.mdc`. |
...
| `language.mdc`                       | persistent context / always-on  | `alwaysApply: true` | English default; **only** `rheyder-method-v1.0-pt_BR.md` in pt-BR                                              | `.cursor/rules/language.mdc` |
